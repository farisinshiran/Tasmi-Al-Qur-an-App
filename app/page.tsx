...
const INITIAL_STUDENTS: Student[] = [
  ...
  { id: 11, no: 11, nama: 'Hizbadien Muhammad', kelas: 'X-4', juz: '3', penguji: 'Ust. Muhammad Fauzi Abdillah', nilai: null, keterangan: 'Belum Tasmi' },
  { id: 12, no: 12, nama: 'Affan Ghazy Kholilullah', kelas: 'X-1', juz: '28', penguji: 'Ust. Muhammad Soffan', nilai: null, keterangan: 'Belum Tasmi' },
  { id: 13, no: 13, nama: 'Aldi Fathan Dulfiqor', kelas: 'XI-2', juz: '29', penguji: 'Ust. Muslim Tasdiq', nilai: null, keterangan: 'Belum Tasmi' },
  { id: 14, no: 14, nama: 'Raditya Nugraha', kelas: 'X-1', juz: '28', penguji: 'Ust. Luqmanul Hakim, S.T', nilai: null, keterangan: 'Belum Tasmi' },
  { id: 15, no: 15, nama: 'Danish Achmad Hawary', kelas: '9C', juz: '29', penguji: 'Ust. Oban Robani', nilai: null, keterangan: 'Belum Tasmi' },
  { id: 16, no: 16, nama: 'Akmal Syahrizal', kelas: 'XI-4', juz: '29', penguji: 'Ust. Muhammad Soffan', nilai: null, keterangan: 'Belum Tasmi' },
  { id: 17, no: 17, nama: 'Ramdan MK', kelas: 'XI-4', juz: '30', penguji: 'Ust. Muslim Tasdiq', nilai: null, keterangan: 'Belum Tasmi' },
  { id: 18, no: 18, nama: 'Affan Ghazy Kholilullah', kelas: 'X-1', juz: '1', penguji: 'Ust. Luqmanul Hakim, S.T', nilai: null, keterangan: 'Belum Tasmi' },
  { id: 19, no: 19, nama: 'Zubair Alfatih', kelas: '7A', juz: '2', penguji: 'Ust. Oban Robani', nilai: 99, keterangan: 'Lulus (Mutqin)' },
  { id: 20, no: 20, nama: 'M Athalarik Wijaya Saputra', kelas: '7A', juz: '30', penguji: 'Ust. Opa Mustofa', nilai: null, keterangan: 'Belum Tasmi' },
  { id: 21, no: 21, nama: 'Muhammad Azzam Huwaidi', kelas: 'XI-2', juz: '30', penguji: 'Ust. Dani Hamdani', nilai: null, keterangan: 'Belum Tasmi' },
  { id: 22, no: 22, nama: 'Muhammad Irham Pane', kelas: 'XI-2', juz: '29', penguji: 'Ust. Muhammad Fauzi Abdillah', nilai: null, keterangan: 'Belum Tasmi' },
  { id: 23, no: 23, nama: 'Muhammad Irham Pane', kelas: 'XI-2', juz: '30', penguji: "Ust. Ja'far Syarif Hidayatullah, S.Pd", nilai: null, keterangan: 'Belum Tasmi' },
  { id: 24, no: 24, nama: 'Imadudin Rijal Al-Faruq', kelas: 'XI-4', juz: '29', penguji: 'Ust. Oban Robani', nilai: 97.5, keterangan: 'Lulus (Mutqin)' },
  { id: 25, no: 25, nama: 'Ismail Fathanul Islam', kelas: 'XI-4', juz: '5', penguji: "Ust. Ja'far Syarif Hidayatullah, S.Pd", nilai: null, keterangan: 'Belum Tasmi' },
  { id: 26, no: 26, nama: 'Yusuf Rizal Abdilllah', kelas: 'XI-4', juz: '30', penguji: 'Ust. Opa Mustofa', nilai: null, keterangan: 'Belum Tasmi' },
  { id: 27, no: 27, nama: 'Muhammad Raihan', kelas: 'XI-4', juz: '1', penguji: 'Ust. Dani Hamdani', nilai: null, keterangan: 'Belum Tasmi' },
  { id: 28, no: 28, nama: 'Zhafran Izharul Haq', kelas: '8D', juz: '29', penguji: 'Ust. Muhammad Fauzi Abdillah', nilai: null, keterangan: 'Belum Tasmi' },
  { id: 29, no: 29, nama: 'Fathir Hafiz Gumilar', kelas: '8C', juz: '30', penguji: 'Ust. Muhammad Soffan', nilai: null, keterangan: 'Belum Tasmi' },
...
/**
 * generateKeterangan:
 * - nilai === null  -> 'Belum Tasmi'
 * - nilai >= 95      -> 'Lulus (Mutqin)'
 * - nilai >= 90      -> 'Lulus'
 * - otherwise        -> 'Tidak Lulus'
 */
function generateKeterangan(nilai: number | null): string {
  ...
  const handleUpdateStudent = (id: number, updates: Partial<Student>) => {
    setStudents((prev) =>
      prev.map((student) => {
        ...
        // Ambil nilai dari updates; bisa berupa number | null | string
        let rawNilai = (updates as any).nilai ?? student.nilai;

        // Normalize: jika empty string diberikan, anggap null
        if (typeof rawNilai === 'string') {
          rawNilai = rawNilai.trim() === '' ? null : Number(rawNilai);
        }

        const nilaiFinal = rawNilai === null || rawNilai === undefined ? null : clampNilai(Number(rawNilai));
